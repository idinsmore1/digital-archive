...
<!-- SerializedQuery: TABLE WITHOUT ID file.link as "album", album_score as "album score", release_year as "release year", genre as "genre" from "music/albums" where album_score != 0 and contains(artist, "{{title}}") sort album_score desc limit 100 -->
